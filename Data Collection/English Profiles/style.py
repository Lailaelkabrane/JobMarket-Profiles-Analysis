...
def combine_csv_files_with_links(file1, file2, file3,file4, output_file):
    """
...
if __name__ == "__main__":
    ...
    file2 = "cleaned_dataset_v2.csv"  # Replace with your first CSV file path
    file1 = "cleaned_dataset_v1.csv"
    file3 = "cleaned_dataset_v3.csv"
    file4="test.csv"
    # Replace with your second CSV file path
    output_file = "combined_profiles_withtest.xlsx"  # Output Excel file name
    
    combine_csv_files_with_links(file1, file2,file3,file4, output_file)