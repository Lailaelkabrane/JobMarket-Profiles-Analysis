...
def main():
    ...
    files = ["dataset1.csv","dataset2.csv","dataset3.csv","dataset4.csv",
             "dataset5.csv","dataset6.csv","dataset7.csv","dataset8.csv",
             "dataset9.csv","dataset10.csv","dataset11.csv","dataset12.csv",'dataset.csv']
    ...
    searched_titles = [  "Responsable Maintenance",
...
"Ingénieur Maintenance Préventive",
"Ingénieur Maintenance Corrective",
"Ingénieur Maintenance Projet",
"Ingénieur Fiabilité Équipements",
"Ingénieur Maintenance Conditionnelle",
"Ingénieur Intégrité des Actifs",
"Coordinateur Maintenance",
"Coordinateur Fiabilité",
"Coordinateur Méthodes Maintenance",
"Chef de Projet Modernisation Maintenance"]
    ...
    def extract_keywords(text):
     ...
     tokens = [re.sub(r"[^a-zàâçéèêëîïôûùüÿñæœ]", "", t) for t in tokens]
    ...
    combined_df["Keywords_Headline"] = combined_df["headline"].apply(
    lambda x: extract_keywords(x).split(" | ") if isinstance(x, str) else [])
    ...
    def filter_by_headline(df, headline_column="headline", keywords=["retraité", "avion"]):
        """
    ...
    def filter_by_headline2(dataframe):
        return dataframe[dataframe["headline"].str.contains("maintenance|fiabilité", case=False, na=False)]
    ...
    final_df = combined_df[["firstName", "lastName", "headline","Keywords_Headline","Target Title","Current position", "currentPosition/0/companyName",
             "location/parsed/country","about", "Keywords","Estimated age","Number of years of experience","connectionsCount",
             "skills/0/name","skills/1/name","skills/2/name","skills/3/name","skills/4/name","skills/5/name",
          "languages/0/name","languages/1/name","languages/2/name","languages/3/name",
            "premium","verified",
            "linkedinUrl"]]
    ...
    final_df.to_csv("fr.csv", index=False, quoting=csv.QUOTE_ALL)
